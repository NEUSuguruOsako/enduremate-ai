...
import { useAuth, validateEmail, validatePasswordStrength } from '../context/AuthContext'
...
export default function Register() {
  ...
  useEffect(() => {
    if (password) {
      ...
      setPasswordStrength({ valid: false, score: 0, messages: [] })
    }
  }, [password])
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3 py-2.5 bg-surface-container-low border rounded-lg text-text-primary focus:ring-2 focus:ring-primary outline-none transition-all font-body-sm ${
                    localErrors.name ? 'border-status-danger' : 'border-border-subtle'
                  }`}
                  placeholder="你的名字"
                  autoComplete="name"
                />
                ...
                <div className="mt-2">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`text-xs font-medium ${
                      passwordStrength.score <= 2 ? 'text-status-danger' :
                      passwordStrength.score <= 4 ? 'text-status-warning' :
                      'text-status-success'
                    }`}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2.5 bg-surface-container-low border rounded-lg text-text-primary focus:ring-2 focus:ring-primary outline-none transition-all font-body-sm ${
                    localErrors.confirmPassword ? 'border-status-danger' : 'border-border-subtle'
                  }`}
                  placeholder="再次输入密码"
                  autoComplete="new-password"
                />
